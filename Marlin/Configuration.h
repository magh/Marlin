...
#define STRING_CONFIG_H_AUTHOR "(ultramaker, ramps14 config)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 240, 240, 2560, 250 }
